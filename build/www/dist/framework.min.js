                ...
                value: function (text, say, allowHtml, extra) {
					...
					if(!window.muteAudio) {
							if (window.sapi) {
								...
								{
									var audio = new Audio("http://localhost/api/v1/sapi?text="+ encodeURIComponent(say) + "&pitch="+_this3.userPublic.pitch+"&speed="+_this3.userPublic.speed+"&guid="+_this3.id+"");
									...
									var audio = new Audio("http://localhost/api/v1/sapi?text="+ encodeURIComponent(say) + "&pitch="+_this3.userPublic.pitch+"&speed="+_this3.userPublic.speed+"&guid="+_this3.id+"&char=clippy");
								} else if (this.userPublic.color == "peedy") {
									var audio = new Audio("http://localhost/api/v1/sapi?text="+ encodeURIComponent(say) + "&pitch="+_this3.userPublic.pitch+"&speed="+_this3.userPublic.speed+"&guid="+_this3.id+"");
								} else if (this.userPublic.color == "max") {
									var audio = new Audio("http://localhost/api/v1/sapi?text="+ encodeURIComponent(say) + "&pitch="+_this3.userPublic.pitch+"&speed="+_this3.userPublic.speed+"&guid="+_this3.id+"");
								} else if (this.userPublic.color == "pm") {
									var audio = new Audio("http://localhost/api/v1/sapi?text="+ encodeURIComponent(say) + "&pitch="+_this3.userPublic.pitch+"&speed="+_this3.userPublic.speed+"&guid="+_this3.id+"&char=paul");
									...
									var audio = new Audio("http://localhost/api/v1/sapi?text="+ encodeURIComponent(say) + "&pitch="+_this3.userPublic.pitch+"&speed="+_this3.userPublic.speed+"&guid="+_this3.id+"&char=Genius");
								} else if (this.userPublic.color == "merlin") {
									var audio = new Audio("http://localhost/api/v1/sapi?text="+ encodeURIComponent(say) + "&pitch="+_this3.userPublic.pitch+"&speed="+_this3.userPublic.speed+"&guid="+_this3.id+"&char=merlin");
									...
									var audio = new Audio("http://localhost/api/v1/sapi?text="+ encodeURIComponent(say) + "&pitch="+_this3.userPublic.pitch+"&speed="+_this3.userPublic.speed+"&guid="+_this3.id+"&char=Robby");
								} else if (this.userPublic.color == "logo") {
									var audio = new Audio("http://localhost/api/v1/sapi?text="+ encodeURIComponent(say) + "&pitch="+_this3.userPublic.pitch+"&speed="+_this3.userPublic.speed+"&guid="+_this3.id+"&char=Paul");
								} else if (this.userPublic.color == "program") {
									var audio = new Audio("http://localhost/api/v1/sapi?text="+ encodeURIComponent(say) + "&pitch="+_this3.userPublic.pitch+"&speed="+_this3.userPublic.speed+"&guid="+_this3.id+"");
								} else if (this.userPublic.color == "pope") {
									var audio = new Audio("http://localhost/api/v1/sapi?text="+ encodeURIComponent(say) + "&pitch="+_this3.userPublic.pitch+"&speed="+_this3.userPublic.speed+"&guid="+_this3.id+"");
								} else if (this.userPublic.color == "donutpope") {
									var audio = new Audio("http://localhost/api/v1/sapi?text="+ encodeURIComponent(say) + "&pitch="+_this3.userPublic.pitch+"&speed="+_this3.userPublic.speed+"&guid="+_this3.id+"");
								} else if (this.userPublic.color == "guestgal") {
									var audio = new Audio("http://localhost/api/v1/sapi?text="+ encodeURIComponent(say) + "&pitch="+_this3.userPublic.pitch+"&speed="+_this3.userPublic.speed+"&guid="+_this3.id+"");
								} else {
									var audio = new Audio("http://localhost/api/v1/sapi?text="+ encodeURIComponent(say) + "&pitch="+_this3.userPublic.pitch+"&speed="+_this3.userPublic.speed+"&guid="+_this3.id+"");
								}
