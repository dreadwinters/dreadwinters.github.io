...
$(function () {
    ...
    (BZWAgents.prototype.getAgent = function (name) {
        if (name) {
            return (
                ["black", "blue", "brown", "green", "purple", "red", "pink", "pope", "cyan", "yellow"].includes(name.toLowerCase()) && (name = "Bonzi"),
...
var clippy = new Agent("Clippy", {
    ...
    pm = new Agent("Pm", {
        ...
        animations: {
            idle: 0,
            surf_away: { frames: range(1, 28), next: "gone", ticks: 52, speed: 1},
    ...
    unbojih = new Agent("Unbojih", {
        size: { x: 170, y: 170 },
        frameSize: { width: 170, height: 170 },
        extras: { nameplateOffset: 20 },
        animations: {
            idle: 0,
            surf_away: { frames: range(28, 1), next: "gone", ticks: 52, speed: 1},	
            surf_intro: { frames: range(7, 10), next: "idle", ticks: 25, speed: 0.3},
            backflip: { frames: range(0, 901), next: "idle", ticks: 901, speed: 1},
            look_left_fwd: [193, 196, "look_left_still", 1],
            look_left_still: 196,
            look_left_back: { frames: range(196, 193), next: "idle", speed: 1},
            greet_fwd: { frames: range(11, 11), next: "greet_still", speed: 1},
            greet_still: 11,
            greet_back: { frames: range(11, 11), next: "idle", speed: 1},
            grin_fwd: { frames: range(17, 17), next: "grin_still", speed: 1},
            grin_still: 17,
            grin_back: { frames: range(17, 17), next: "idle", speed: 1},
            laugh_fwd: { frames: [0,17,43], next: "laugh_still", speed: 0.5},
            laugh_still: { frames: [43, 43], next: "laugh_still", speed: 0.5}, 
            laugh_back: { frames: [43,17,0], next: "idle", speed: 0.5},
...
var BonziData = {
    ...
    sprite: {
        ...
        animations: {
            ...
            fly_fwd: [331, 335, "fly_still", 1],
            fly_still: [335, 338, "fly_still", 1],
            fly_back: [338, 343, "idle", 1],
        },
    },
    to_idle: {
                ...
                value: function (text, say, allowHtml, extra) {
                    ...
                    function speakFallback() {
                        fallbackSpeaking ||
                            ...
                            speak.play(
                                say,
                                { pitch: _this3.userPublic.pitch, speed: _this3.userPublic.speed, amplitude: _this3.userPublic.amplitude },
                                function () {
