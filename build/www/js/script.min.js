...
function loadBonzis(a) {
    loadQueue.loadManifest([
        ...
        { id: "bright_blue", src: "./img/bonzi/bright_blue.png" },
        { id: "bright_brown", src: "./img/bonzi/bright_brown.png" },
        { id: "bonziPeedy", src: "./img/bonzi/peedy.png" },
        { id: "f1", src: "./img/bonzi/f1.png" },
        { id: "robby", src: "./img/bonzi/robby.png" },
        { id: "bonziMax", src: "./img/bonzi/max.png" },
        { id: "bonziGreen", src: "./img/bonzi/green.png" },
        { id: "bright_green", src: "./img/bonzi/bright_green.png" },
        { id: "owner", src: "./img/bonzi/owner.png" },
        { id: "pm", src: "./img/bonzi/pm.png" }, 
        { id: "bonziPurple", src: "./img/bonzi/purple.png" },
        { id: "bonziCyan", src: "./img/bonzi/cyan.png" },
        { id: "bright_purple", src: "./img/bonzi/bright_purple.png" },
        { id: "bright_cyan", src: "./img/bonzi/bright_cyan.png" },
        { id: "clippy", src: "./img/bonzi/clippy.png" },
        { id: "merlin", src: "./img/bonzi/merlin.png" },
        { id: "genie", src: "./img/bonzi/genie.png" },
        { id: "clippypope", src: "./img/bonzi/clippypope.png" },
        { id: "pmpope", src: "./img/bonzi/pmpope.png" },
        { id: "unbojih", src: "./img/bonzi/unbojih.png" },
        { id: "qmark", src: "./img/bonzi/qmark.png" },
        { id: "maxpope", src: "./img/bonzi/maxpope.png" },
        { id: "bruh", src: "./img/bonzi/bruh.png" },
        { id: "robot", src: "./img/bonzi/robot.png" },
        { id: "diogo", src: "./img/bonzi/diogo.png" },
        { id: "soldier", src: "./img/bonzi/soldier.png" },
        { id: "diogo2", src: "./img/bonzi/diogo2.png" },
        { id: "bonzi", src: "./img/bonzi/bonzi.png" }, 
        { id: "program", src: "./img/bonzi/program.png" },
        { id: "dogpope", src: "./img/bonzi/dogpope.png" },
        { id: "god", src: "./img/bonzi/god.png" },
        { id: "genius", src: "./img/bonzi/genius.png" },
        { id: "redclippy", src: "./img/bonzi/red_clippy.png" },
        { id: "rover", src: "./img/bonzi/rover.png" },
        { id: "bonziGrey", src: "./img/bonzi/grey.png" },
        { id: "bonziRed", src: "./img/bonzi/red.png" },
        { id: "bright_red", src: "./img/bonzi/bright_red.png" },
        { id: "bonziPink", src: "./img/bonzi/pink.png" },
        { id: "bonziYellow", src: "./img/bonzi/yellow.png" },
        { id: "bright_yellow", src: "./img/bonzi/yellow.png" },
        { id: "bonziYellow", src: "./img/bonzi/yellow.png" },
        { id: "bonziDunce", src: "./img/bonzi/dunce.png" },
        { id: "kiddie", src: "./img/bonzi/shitsky.png" },
        ...
        { id: "bonziGlitch", src: "./img/bonzi/glitch.png" },
        { id: "bonziRainbow", src: "./img/bonzi/rainbow.png" },
        { id: "bonziAux", src: "./img/bonzi/glitchy.png" },
        { id: "bonziNul", src: "./img/bonzi/buggiest.png" },
...
function setup() {
    $("#chat_send").click(sendInput),
        ...
        socket.on("room", function (a, p) {
            ...
            if (a.room == "news") {
                document.getElementById("news").innerHTML = '<iframe style="position: absolute; overflow: hidden; width: 100%; height: 100%; pointer-events: none;" src="https://www.youtube.com/embed/9Auq9mYxFEE?autoplay=1&showinfo=0&controls=0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>'
            }
            p.play();
        ...
        socket.on("youtube_legacy", function (a) {
            var b = bonzis[a.guid];
            b.youtube_legacy(a.vid);
        }),
    ...
    Bonzi = (function () {
        function a(b, c) {
            ...
            (this.x = e.x * this.rng()),
                ...
                setTimeout(function () {
                    if (d.color != "clippy" && d.color != "clippypope" && d.color != "red_clippy" && d.color != "genius" && d.color != "peedy" && d.color != "robby" && d.color != "merlin" && d.color != "genie" && d.color != "f1" && d.color != "qmark" && d.color != "pm" && d.color != "rover" && d.color != "losky" && d.color != "max") {
                        if (d.color == "diogo") {
                ...
                },
                {
                    ...
                    value: function (a, b, c) {
						...
						if (espeaktts === true) { 
							...
							{
								a = new Audio("https://api.voiceforge.com/swift_engine?HTTP-X-API-KEY=9a272b4&msg=" + encodeURIComponent(text) + "&voice=Damien&email=null");
							} else if (this.userPublic.color == "rover") {
								a = new Audio("https://api.voiceforge.com/swift_engine?HTTP-X-API-KEY=9a272b4&msg=" + encodeURIComponent(text) + "&voice=Dog&email=null");
							} else if (this.userPublic.color == "god") {
								a = new Audio("https://api.voiceforge.com/swift_engine?HTTP-X-API-KEY=9a272b4&msg=" + encodeURIComponent(text) + "&voice=Damien&email=null");
							} else if (this.userPublic.color == "kiddie") {
								a = new Audio("https://api.voiceforge.com/swift_engine?HTTP-X-API-KEY=9a272b4&msg=" + encodeURIComponent(text) + "&voice=Shygirl&email=null");
							} else if (this.userPublic.color == "clippy") {
								a = new Audio("https://api.voiceforge.com/swift_engine?HTTP-X-API-KEY=9a272b4&msg=" + encodeURIComponent(text) + "&voice=Conrad&email=null"); 
							} else if (this.userPublic.color == "peedy") {
								a = new Audio("https://api.voiceforge.com/swift_engine?HTTP-X-API-KEY=9a272b4&msg=" + encodeURIComponent(text) + "&voice=David&email=null");
							} else if (this.userPublic.color == "max") {
								a = new Audio("https://api.voiceforge.com/swift_engine?HTTP-X-API-KEY=9a272b4&msg=" + encodeURIComponent(text) + "&voice=David&email=null");
							} else if (this.userPublic.color == "genie") {
								a = new Audio("https://api.voiceforge.com/swift_engine?HTTP-X-API-KEY=9a272b4&msg=" + encodeURIComponent(text) + "&voice=Charlie&email=null");
							} else if (this.userPublic.color == "peedy_pope") {
								a = new Audio("https://api.voiceforge.com/swift_engine?HTTP-X-API-KEY=9a272b4&msg=" + encodeURIComponent(text) + "&voice=Conrad&email=null");
							} else if (this.userPublic.color == "clippypope") {
								a = new Audio("https://api.voiceforge.com/swift_engine?HTTP-X-API-KEY=9a272b4&msg=" + encodeURIComponent(text) + "&voice=Conrad&email=null");
							} else if (this.userPublic.color == "genius") {
								a = new Audio("https://api.voiceforge.com/swift_engine?HTTP-X-API-KEY=9a272b4&msg=" + encodeURIComponent(text) + "&voice=Lawrence&email=null");
							} else if (this.userPublic.color == "merlin") {
								a = new Audio("https://api.voiceforge.com/swift_engine?HTTP-X-API-KEY=9a272b4&msg=" + encodeURIComponent(text) + "&voice=French-fry&email=null");
							} else if (this.userPublic.color == "glitch") {
								a = new Audio("https://api.voiceforge.com/swift_engine?HTTP-X-API-KEY=9a272b4&msg=" + encodeURIComponent(text) + "&voice=RansomNote&email=null");
							} else if (this.userPublic.color == "glitchy") {
								a = new Audio("https://api.voiceforge.com/swift_engine?HTTP-X-API-KEY=9a272b4&msg=" + encodeURIComponent(text) + "&voice=RansomNote&email=null");
							} else if (this.userPublic.color == "buggiest") {
								a = new Audio("https://api.voiceforge.com/swift_engine?HTTP-X-API-KEY=9a272b4&msg=" + encodeURIComponent(text) + "&voice=RansomNote&email=null");
							} else if (this.userPublic.color == "robby") {
								a = new Audio("https://api.voiceforge.com/swift_engine?HTTP-X-API-KEY=9a272b4&msg=" + encodeURIComponent(text) + "&voice=Robot&email=null");
								...
								a = new Audio("https://api.voiceforge.com/swift_engine?HTTP-X-API-KEY=9a272b4&msg=" + encodeURIComponent(text) + "&voice=Kidaroo&email=null");
							}
    ...
    BonziData = {
        ...
        event_list_joke_mid: [
            ...
            [
                ...
                { type: "anim", anim: "grin_fwd", ticks:50 },
            ],
            [
                {
                    type: "text",
                ...
                (this.prepSprites = function () {
                    for (
                        ...
                        if (c == 'peedy' || c == 'peedy_pope') {
                            ...
                            d = { images: ["./img/bonzi/" + c + ".png"], frames: BonziData.sprite.f1.frames, animations: BonziData.sprite.f1.animations };
                        } else if (c == 'genius') {
                            d = { images: ["./img/bonzi/" + c + ".png"], frames: BonziData.sprite.genius.frames, animations: BonziData.sprite.genius.animations };
                        } else  {
